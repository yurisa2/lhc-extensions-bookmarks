...
function UsersTableName()
{
	...
	return $connection->addTableWrappers("lh_users");
}
...
class tDAL
{
	var $tblwappchat_at_wappchat_mysql_dbaas_com_br__bookmarks;
	var $tblwappchat_at_wappchat_mysql_dbaas_com_br__bookmarks_inits;
	var $tblwappchat_at_wappchat_mysql_dbaas_com_br__lh_abstract_auto_responder;
	var $tblwappchat_at_wappchat_mysql_dbaas_com_br__lh_users;
	var $tblwappchat_at_wappchat_mysql_dbaas_com_br__lh_users_online_session;
	var $lstTables;
	var $Table = array();
